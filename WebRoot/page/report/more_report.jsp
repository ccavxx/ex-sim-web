	...
	<div data-options="region:'north',collapsible:false,height:63" title="${title}" style="overflow: hidden">
		<div class="datagrid-toolbar" style="height:30px;">
			<div class="pull-left input-prepend input-append" style="padding:3px 5px 0px 5px" >
				<c:if test="${!empty dslist }&&　${!empty bean.dvcaddress}">
			...
			<div id="paramItems" class="pull-left" style="margin-left:8px;display:none;">
				<form id="form_more_report" method="post">  
					...
					<div class="input-prepend input-append">
						...
						<input style="width: 133px;" class="cursorHand" id="talStartTime" type="text" value="${bean.talStartTime }" readonly="readonly">
						<span class="add-on">-</span>
						<input style="width: 133px;" class="cursorHand" id="talEndTime" type="text"  value="${bean.talEndTime }" readonly="readonly">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton" class="add-on" onclick="report.moreRptQuery('${moreUrl}');">查询</a>
					</div>
				</form>  
			</div>
			<div id="exportBtns" class="pull-right">
				<a href="javascript:void(0)" class="easyui-linkbutton add-on" iconCls='icon-goback' onclick="report.goBack('${goUrl}')" >返回</a>
			</div>
		</div>
	</div>
