...
!function ($) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if(typeof options.onMonthYearChange == 'function'){
            	this.onMonthYearChange = options.onMonthYearChange ;
            }
            if (!this.timePicker) {
        ...
        clickPrev: function (e) {
            ...
            this.updateCalendars();
            if(this.onMonthYearChange){
            	var month = parseInt(cal.find('.monthselect').val(), 10);
                var year = cal.find('.yearselect').val();
            	this.onMonthYearChange(isLeft,month,year) ;
            }
        },
